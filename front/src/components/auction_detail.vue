        ...
        <nav class="main_b_nav">
            <ul class="main_b_nav_list">
                ...
                <li class="nav__btn">
                    ...
                    <a class="nav__link" href="search"><i class="fas fa-magnifying-glass fa-2x" aria-hidden="true"></i>
                    </a>
                </li>
                <li class="nav__btn">
                    <a class="nav__link" href="regester_auction"><i class="fas fa-apple-whole fa-2x"
                            aria-hidden="true"></i>
                    </a>
                </li>
                <li class="nav__btn">
                    <div class="nav__notification-dot"></div>
                    <a class="nav__link" href="farm_produce_trand"><i class="fas fa-leaf fa-2x" aria-hidden="true"></i>
                    </a>
                </li>
                <li class="nav__btn">
                    <div class="nav__notification-dot"></div>
